...
import 'package:masaku/views/info-screen/info_hipertensi_screen.dart';
...
class KategoriHipertensiScreen extends StatelessWidget {
  const KategoriHipertensiScreen({super.key});
