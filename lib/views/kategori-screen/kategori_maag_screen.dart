...
import 'package:masaku/views/info-screen/info_maag_screen.dart';
...
class KategoriMaagScreen extends StatelessWidget {
  const KategoriMaagScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              width: 300.w,
              child: Text(
                "Makanan lunak, mudah dicerna, dan rendah asam",
                style:
